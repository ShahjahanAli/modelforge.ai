  ...
  return (
    <>
      <PageHeader
        eyebrow="Credentials"
        title="API keys"
        description="Bearer tokens for the OpenAI-compatible gateway. Rotate regularly and scope one key per deployment."
        actions={
      ...
      <Panel>
        <PanelHeader title="Existing keys" description={`${keys.length} total`} />
        {keys.length === 0 ? (
          <EmptyState
            icon={KeyRound}
